...
{
    [Serializable]
    public struct DateTime2 : IComparable, IFormattable, IConvertible, ISerializable, IComparable<DateTime2>, IEquatable<DateTime2>
    {
        // Fields
        ...
        public static readonly DateTime2 MaxValue;
        ...
        public static readonly DateTime2 MinValue;
        ...
        static DateTime2()
        {
            ...
            MinValue = new DateTime2(0L, DateTimeKind.Unspecified);
            MaxValue = new DateTime2(0x2bca2875f4373fffL, DateTimeKind.Unspecified);
        }

        public DateTime2(long ticks)
        {
        ...
        private DateTime2(ulong dateData)
        {
            this.dateData = dateData;
        }

        public DateTime2(long ticks, DateTimeKind kind)
        {
            if ((ticks < 0L) || (ticks > 0x2bca2875f4373fffL))
            {
                throw new ArgumentOutOfRangeException("ticks", Environment.GetResourceString("ArgumentOutOfRange_DateTimeBadTicks"));
        ...
        private DateTime2(SerializationInfo info, StreamingContext context)
        {
            if (info == null)
            {
        ...
        public DateTime2(int year, int month, int day)
        {
            this.dateData = (ulong)DateToTicks(year, month, day);
        }

        internal DateTime2(long ticks, DateTimeKind kind, bool isAmbiguousDst)
        {
            if ((ticks < 0L) || (ticks > 0x2bca2875f4373fffL))
            {
                throw new ArgumentOutOfRangeException("ticks", Environment.GetResourceString("ArgumentOutOfRange_DateTimeBadTicks"));
        ...
        public DateTime2(int year, int month, int day, Calendar calendar)
            : this(year, month, day, 0, 0, 0, calendar)
        {
        }

        public DateTime2(int year, int month, int day, int hour, int minute, int second)
        {
            this.dateData = (ulong)(DateToTicks(year, month, day) + TimeToTicks(hour, minute, second));
        }

        public DateTime2(int year, int month, int day, int hour, int minute, int second, DateTimeKind kind)
        {
        ...
        public DateTime2(int year, int month, int day, int hour, int minute, int second, Calendar calendar)
        {
            if (calendar == null)
            {
        ...
        public DateTime2(int year, int month, int day, int hour, int minute, int second, int millisecond)
        {
            long num = DateToTicks(year, month, day) + TimeToTicks(hour, minute, second);
        ...
        public DateTime2(int year, int month, int day, int hour, int minute, int second, int millisecond, DateTimeKind kind)
        {
            long num = DateToTicks(year, month, day) + TimeToTicks(hour, minute, second);
            if ((millisecond < 0) || (millisecond >= 0x3e8))
            {
        ...
        public DateTime2(int year, int month, int day, int hour, int minute, int second, int millisecond, Calendar calendar)
        {
            if (calendar == null)
            {
                throw new ArgumentNullException("calendar");
        ...
        public DateTime2(int year, int month, int day, int hour, int minute, int second, int millisecond, Calendar calendar, DateTimeKind kind)
        {
            if (calendar == null)
            {
                throw new ArgumentNullException("calendar");
        ...
        public DateTime2 Add(TimeSpan value)
        {
            return this.AddTicks(value._ticks);
        }

        private DateTime2 Add(double value, int scale)
        {
        ...
        public DateTime2 AddDays(double value)
        {
            return this.Add(value, 0x5265c00);
        }

        public DateTime2 AddHours(double value)
        {
            return this.Add(value, 0x36ee80);
        }

        public DateTime2 AddMilliseconds(double value)
        {
            return this.Add(value, 1);
        }

        public DateTime2 AddMinutes(double value)
        {
            return this.Add(value, 0xea60);
        }

        public DateTime2 AddMonths(int months)
        {
            ...
            return new DateTime2(((ulong)(DateToTicks(datePart, month, day) + (this.InternalTicks % 0xc92a69c000L))) | this.InternalKind);
        }

        public DateTime2 AddSeconds(double value)
        {
            return this.Add(value, 0x3e8);
        }

        public DateTime2 AddTicks(long value)
        {
            long internalTicks = this.InternalTicks;
            ...
            return new DateTime2(((ulong)(internalTicks + value)) | this.InternalKind);
        }

        public DateTime2 AddYears(int value)
        {
        ...
        public static int Compare(DateTime2 t1, DateTime2 t2)
        {
        ...
        public int CompareTo(DateTime2 value)
        {
        ...
        public bool Equals(DateTime2 value)
        {
        ...
        public static bool Equals(DateTime2 t1, DateTime2 t2)
        {
            return (t1.InternalTicks == t2.InternalTicks);
        }

        public static DateTime2 FromBinary(long dateData)
        {
            ...
            {
                utcOffsetFromUniversalTime = ((CurrentSystemTimeZone)TimeZone.CurrentTimeZone).GetUtcOffsetFromUniversalTime(new DateTime2(ticks), ref isAmbiguousLocalDst);
            }
            ...
            return new DateTime2(ticks, DateTimeKind.Local, isAmbiguousLocalDst);
        }

        internal static DateTime2 FromBinaryRaw(long dateData)
        {
            ...
            return new DateTime2((ulong)dateData);
        }

        public static DateTime2 FromFileTime(long fileTime)
        {
            return FromFileTimeUtc(fileTime).ToLocalTime();
        }

        public static DateTime2 FromFileTimeUtc(long fileTime)
        {
            ...
            return new DateTime2(fileTime + 0x701ce1722770000L, DateTimeKind.Utc);
        }

        public static DateTime2 FromOADate(double d)
        {
            return new DateTime2(DoubleDateToTicks(d), DateTimeKind.Unspecified);
        }
        ...
        public static DateTime2 operator +(DateTime2 d, TimeSpan t)
        {
            ...
            return new DateTime2(((ulong)(internalTicks + num2)) | d.InternalKind);
        }

        public static bool operator ==(DateTime2 d1, DateTime2 d2)
        {
            return (d1.InternalTicks == d2.InternalTicks);
        }

        public static bool operator >(DateTime2 t1, DateTime2 t2)
        {
            return (t1.InternalTicks > t2.InternalTicks);
        }
        ...
        public static TimeSpan operator -(DateTime2 d1, DateTime2 d2)
        {
        ...
        public static DateTime2 Parse(string s, IFormatProvider provider)
        {
        ...
        public static DateTime2 SpecifyKind(DateTime2 value, DateTimeKind kind)
        {
            return new DateTime2(value.InternalTicks, kind);
        }

        public TimeSpan Subtract(DateTime2 value)
        {
            return new TimeSpan(this.InternalTicks - value.InternalTicks);
        }

        public DateTime2 Subtract(TimeSpan value)
        {
            long internalTicks = this.InternalTicks;
            ...
            return new DateTime2(((ulong)(internalTicks - num2)) | this.InternalKind);
        }
        ...
        DateTime2 IConvertible.ToDateTime(IFormatProvider provider)
        {
            return this;
        }
        ...
        public DateTime2 ToUniversalTime()
        {
            return TimeZone.CurrentTimeZone.ToUniversalTime(this);
        }

        internal static bool TryCreate(int year, int month, int day, int hour, int minute, int second, int millisecond, out DateTime2 result)
        {
            result = MinValue;
            if (((year < 1) || (year > 0x270f)) || ((month < 1) || (month > 12)))
            {
            ...
            result = new DateTime2(ticks, DateTimeKind.Unspecified);
            return true;
        }
        ...
        public DateTime2 Date
        {
            ...
            {
                long internalTicks = this.InternalTicks;
                return new DateTime2(((ulong)(internalTicks - (internalTicks % 0xc92a69c000L))) | this.InternalKind);
            }
        }
        ...
        public static DateTime2 UtcNow
        {
            get
            {
                return new DateTime2((ulong)((GetSystemTimeAsFileTime() + 0x701ce1722770000L) | 0x4000000000000000L));
            }
        }
